...
*/
  console.log('O resultado da soma é: ' + sum(function (c, d) { return c + d }))
...
*/
  var subtraction = calculator(7, 3)
  var multiplication = calculator(3, 4)
  var division = calculator(81, 9)
  var mod = calculator(25, 2)
...
chamada.
*/
  console.log('O resultado da subtração é:' + subtraction(function (c, d) { return c - d }))
  console.log('O resultado da multiplicação é:' + multiplication(function (c, d) { return c * d }))
  console.log('O resultado da divisão é:' + division(function (c, d) { return c / d }))
  console.log('O resto da divisão é:' + mod(function (c, d) { return c % d }))
})()
