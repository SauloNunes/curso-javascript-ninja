...
carro.adicionarPessoa = function(x){
  if (carro.quantidadePessoas === carro.assentos) {return 'O carro já está lotado!'}
    ...
    let pessoa = carro.assentos - carro.quantidadePessoas === 1 ? ' pessoa' : ' pessoas'
...
// E agora, qual a cor do carro?
carro.obterCor() //'verde musho'

// Qual a marca e modelo do carro?
carro.obterMarcaModelo() //'Esse carro é um Ford Ka'

// Adicione 2 pessoas no carro.
carro.adicionarPessoa(2) //'Já temos 2 no carro!'
