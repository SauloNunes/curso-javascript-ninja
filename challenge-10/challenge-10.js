...
*/
  ...
  console.log(' + é um operador valido? ' + isOperatorValid('+'))
  console.log(' - é um operador valido? ' + isOperatorValid('-'))
  console.log(' * é um operador valido? ' + isOperatorValid('*'))
  console.log(' / é um operador valido? ' + isOperatorValid('/'))
  console.log(' % é um operador valido? ' + isOperatorValid('%'))
  console.log(' x é um operador valido? ' + isOperatorValid('x'))
  /*
...
*/
  ...
  console.log('x' + calculator('+')('s', 1))
  console.log('x' + calculator('+')(1, 's'))
  console.log('x' + calculator('+')('s', 's'))
  /*
...
*/
  operationSignal = 'x'
  var invalidx = calculator(operationSignal)
  if (invalidx) {
    console.log(showOperationMessage(operationSignal, number1, number2), invalidx(number1, number2))
  } else {
    console.log(showErrorMessage(operationSignal))
  }
})()
